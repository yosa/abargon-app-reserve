...
require_once __DIR__ . '/../App/Reserve/Application.php';

$app = new App\Reserve\Application(
    [
        'base'=>  realpath(__DIR__ . '/../App/Reserve'),
        'storage'=> realpath(__DIR__ . '/../App/Reserve/storage'),
